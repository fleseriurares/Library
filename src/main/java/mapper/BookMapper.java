...
public class BookMapper {
    ...
    public static Book convertBookDTOToBook(BookDTO bookDTO){
        return new BookBuilder().setTitle(bookDTO.getTitle()).setAuthor(bookDTO.getAuthor()).setPublishedDate(LocalDate.of(2010,10,10)).setPrice(bookDTO.getPrice()).setStock(bookDTO.getStock()).build();
    }
